        ...
        if(!err){
          // if(result.xml.MsgType[0] === 'text'){
            ...
            .then(function(userInfo){
              ...
              // console.log("MsgType : %s",replyType[result.xml.MsgType[0]]);
              var res = replyText(result,replyType[result.xml.MsgType[0]] );//'消息推送成功！');
            // var res = replyText(result,  replyType[result.xml.MsgType[0]]);
              console.log("---------------%s",res);
              response.end(res);
            })
          // }
